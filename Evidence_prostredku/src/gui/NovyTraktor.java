...
public class NovyTraktor {
    ...
    public void start(final Stage parentStage, final Seznam seznam) {
        ...
        TextField tfTah = createTextField(130.0, 150.0);
        ...
        bUloz.setOnAction((event) -> {
            try {
                seznam.pridej(new Traktor(
                        Double.parseDouble(tfTah.getText()),
                        tfSPZ.getText(),
