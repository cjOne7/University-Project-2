...
// ----- konfigurace -----------------------------------------------------------   
     ...
     * seznamu porovnávat. Funkční je vždy poslední verze komparátoru. Komparátor
...
// ----- pohyb po seznamu, nastavení aktuálního prostředku ---------------------    
     ...
     */
    void nastavAktualniPolozku(E klic);
     ...
     *
     * @throws OvladaniException vystavení výjimky při nenastavené aktuální
     * položce.
     */
    E vyjmiAktualniPolozku() throws OvladaniException;
     ...
     *
     *
     * @param editor odkaz na objekt s editorem jedné datové položky
     */
...
// ----- nástroje --------------------------------------------------------------    
     ...
     * </ol>
     * <p>
     * Převod textu na objekty zajistí mapovací objekt. například
     * <pre>
    ...
    /**
     * Metoda vrátí maximální povolený počet datových položek v seznamu 
     * @return
     */
    int dejPocetPolozekMax();
